...
export const createOrder = (order) => async (dispatch, getState) => {
  try {
    ...
    localStorage.setItem("orders", JSON.stringify(getState().orderList.orders))
  } catch (error) {
